                ...
                <div class="submain">
                    <div class="container py-3">
                        ...
                        <div class="pagination">
                            ...
                            // Previous button
                            if ($current_page > 1) {
                                echo '<a href="myconstruct.php?page=' . ($current_page - 1) . '&sort_order=' . $sort_order . '&search=' . $search_keyword . '" class="button-7">Previous</a>';
                            } else {
                            ...
                            for ($i = 1; $i <= $total_pages; $i++) {
                                if ($i == $current_page) {
                                    ...
                                    echo '<a href="myconstruct.php?page=' . $i . '&sort_order=' . $sort_order . '&search=' . $search_keyword . '">' . $i . '</a>';
                                }
                            }

                            // Next button
                            if ($current_page < $total_pages) {
                                echo '<a href="myconstruct.php?page=' . ($current_page + 1) . '&sort_order=' . $sort_order . '&search=' . $search_keyword . '" class="button-7">Next</a>';
                            } else {
